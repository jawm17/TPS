    ...
    <>
        ...
        <div id="headerInner">
          ...
          <div id="headerLinks">
            ...
            <div
              ...
              id={props.page === "builds" ? "selectedPage" : ""}
              onClick={
                buildsMenuOpen
                  ? () => setBuildsMenuOpen(false)
                  : () => setBuildsMenuOpen(true)
              }
              onMouseEnter={() => setBuildsMenuOpen(true)}
            >
              {props.page !== "builds" ? (
                <svg
                  id="headerIcon"
              ...
              {buildsMenuOpen ? (
                <div
                  id="buildsMenu"
                  onMouseLeave={() => setBuildsMenuOpen(false)}
                >
                  <div
                    className="buildsMenuItem"
                    onClick={() => navigateMobileMenu("/builds")}
                  >
                    New Pool Construction
                  </div>
                  <div
                    className="buildsMenuItem"
                    onClick={() => navigateMobileMenu("/renovation")}
                  >
                    Pool Renovation
                  </div>
                </div>
            ...
            <div
              className="headerLink"
              id={props.page === "services" ? "selectedPage" : ""}
            ...
            >
              ...
              <div>POOL SERVICES</div>
            </div>
            <div
              className="headerLink"
              id={props.page === "remodling" ? "selectedPage" : ""}
              onClick={
                locationsOpen
                  ? () => setLocationsOpen(false)
            ...
            >
              ...
              {locationsOpen ? (
                ...
                >
                  ...
                  <div
                    className="locationMenuItem"
                    onClick={() => navigateMenu("2")}
                  >
                    Westlake
                  </div>
                  <div
                    className="locationMenuItem"
                    onClick={() => navigateMenu("3")}
                  >
                    The Hills
                  </div>
                  <div
                    className="locationMenuItem"
                    onClick={() => navigateMenu("4")}
                  >
                    Spicewood
                  </div>
                  <div
                    className="locationMenuItem"
                    onClick={() => navigateMenu("5")}
                  >
                    Dripping Springs
                  </div>
                  <div
                    className="locationMenuItem"
                    onClick={() => navigateMenu("6")}
                  >
                    Lago Vista
                  </div>
                  <div
                    className="locationMenuItem"
                    onClick={() => navigateMenu("7")}
                  >
                    Lakeway
                  </div>
                </div>
            ...
            <div
              className="headerLink"
              id={props.page === "about" ? "selectedPage" : ""}
            ...
            <div
              id="contactBtnHeader"
              onClick={() => (window.location.href = `tel:${5128207434}`)}
            >
              CALL NOW
            </div>
            {menuOpen ? (
      ...
      <div id={menuOpen ? "mobileMenuOpen" : "mobileMenu"}>
        ...
        <div className="mobileMenuItem">
          ...
          {dropOpen2 ? (
            <div id="menuDropDownArea">
              <div
                className="dropDownOption"
                onClick={() => navigateMobileMenu("/services")}
              >
                Repairs
              </div>
              <div
        ...
        <div className="mobileMenuItem">
          <div
            className="mobileMenuItemTop"
            onClick={() => setDropOpen3(!dropOpen3)}
          >
            <svg
              id="headerIcon"
              xmlns="https://www.w3.org/2000/svg"
        ...
        <div className="mobileMenuItem">
          <div
            className="mobileMenuItemTop"
            onClick={() => navigateMobileMenu("/about")}
          >
            <svg
              id="headerIcon"
              xmlns="https://www.w3.org/2000/svg"
