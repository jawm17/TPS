                ...
                <div id="headerInner">
                    ...
                    <div id="headerLinks">
                        <div className="headerLink" id={props.page === "builds" ? "selectedPage" : ""} onClick={buildsMenuOpen ? () => setBuildsMenuOpen(false) : () => setBuildsMenuOpen(true)} >
                            {props.page === "builds" || props.page === "renovation" ?
                        ...
                        <div className="headerLink" id={props.page === "services" ? "selectedPage" : ""} onClick={servicesMenuOpen ? () => setServicesMenuOpen(false) : () => setServicesMenuOpen(true)} >
                            {props.page !== "services" ?
                                <svg id="headerIcon" xmlns="https://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 18.75a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 0 1-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 0 0-3.213-9.193 2.056 2.056 0 0 0-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 0 0-10.026 0 1.106 1.106 0 0 0-.987 1.106v7.635m12-6.677v6.677m0 4.5v-4.5m0 0h-12" />
                                </svg>
                            ...
                            {servicesMenuOpen ?
                                <div id="servicesMenu" onMouseLeave={() => setServicesMenuOpen(false)}>
                                    <div className="buildsMenuItem" onClick={() => navigateMobileMenu("/services")}>
                                        Replastering
                                    </div>
                                    <div className="buildsMenuItem" onClick={() => navigateMobileMenu("/services")}>
                                        Maintenance
            ...
            <div id={menuOpen ? "mobileMenuOpen" : "mobileMenu"}>
                <div id="mobileMenuInner">
                    ...
                    <div className="mobileMenuItem">
                        ...
                        {dropOpen3 ?
                            <div id="menuDropDownArea">
                                <div className="dropDownOption" onClick={() => navigateMenu("8")}>
                                    Austin
                                </div>
                                ...
                                <div className="dropDownOption" onClick={() => navigateMenu("9")}>
                                    Georgetown
                                </div>
                                <div className="dropDownOption" onClick={() => navigateMenu("10")}>
                                    Round Rock
                                </div>
                                <div className="dropDownOption" onClick={() => navigateMenu("11")}>
                                    Cedar Park
                                </div>
                                <div className="dropDownOption" onClick={() => navigateMenu("12")}>
                                    Leander
                                </div>
                                <div className="dropDownOption" onClick={() => navigateMenu("13")}>
                                    Pflugerville
                                </div>
                                <div className="dropDownOption" onClick={() => navigateMenu("15")}>
                                    Salado
                                </div>
                                <div className="dropDownOption" onClick={() => navigateMenu("16")}>
                                    Wimberly
                                </div>
                                <div className="dropDownOption" onClick={() => navigateMenu("17")}>
                                    Liberty Hill
                                </div>
                                <div className="dropDownOption" onClick={() => navigateMenu("18")}>
                                    Blanco
                                </div>
                                <div className="dropDownOption" onClick={() => navigateMenu("19")}>
                                    Buda
                                </div>
                                <div className="dropDownOption" onClick={() => navigateMenu("20")}>
                                    Kyle
                                </div>
                                <div className="dropDownOption" onClick={() => navigateMenu("21")}>
                                    New Braunfels
                                </div>
                                <div className="dropDownOption" onClick={() => navigateMenu("22")}>
                                    Bastrop
                                </div>
                                <div className="dropDownOption" onClick={() => navigateMenu("23")}>
                                    Elgin
                                </div>
                                <div className="dropDownOption" onClick={() => navigateMenu("24")}>
                                    Manor
                                </div>
                            </div>
                            :
